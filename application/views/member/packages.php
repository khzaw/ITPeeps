...
<div id="content">
	...
	<div class="boxed">
		<h1 class="title2">Travel Packages</h1>
		
		
		<?php foreach($packages as $package): ?>
		
			<div class="package">
				<h3><?php echo anchor("packages/details/". $package['id'], $package['name']); ?></h3>
				<img src=<?php echo base_url(). 'images/packages/' . $package['image'] ;?> width="600" height="350"/>
